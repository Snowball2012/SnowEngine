...
[[vk::location( 0 )]] float4 FullScreenQuadVS( in uint vertex_id : SV_VertexID, [[vk::location( 1 )]] out float2 uv : TEXCOORD0 ) : SV_POSITION
{
...
[[vk::location( 0 )]] float4 FullScreenQuadPS( [[vk::location( 1 )]] in float2 uv : TEXCOORD0 ) : SV_TARGET0
{
